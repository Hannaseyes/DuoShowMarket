	...
	<div class="header2 text-center">
		<div class="container">
			<div class="main-header">
				...
				<div class="logo">
					<h3>
						<a href="index.html">NEW FASHIONS</a>
					</h3>
				</div>
				<div class="box_1">
					<a href="cart.html"><h3>
							...
							items)<img src="images/cart.png" alt="" />
						</h3></a>
					<p>
					...
					<div class="single-page">
						...
						<div class="details-left-slider">
							<ul id="etalage">
								<li><a href="optionallink.html"> <img
										class="etalage_thumb_image" src="images/s1.jpg" /> <img
										class="etalage_source_image" src="images/s1.jpg" />
								</a></li>
								<li><img class="etalage_thumb_image" src="images/s2.jpg" />
									<img class="etalage_source_image" src="images/s2.jpg" /></li>
								<li><img class="etalage_thumb_image" src="images/s3.jpg" />
									<img class="etalage_source_image" src="images/s3.jpg" /></li>
								<li><img class="etalage_thumb_image" src="images/s4.jpg" />
									<img class="etalage_source_image" src="images/s4.jpg" /></li>
								<div class="clearfix"></div>
							</ul>
						</div>
						<div class="details-left-info">
							...
							<div class="flower-type">
								<p>
									Mobel ::<a href="#">Dress</a>
								</p>
								<p>
									Brand ::<a href="#">Pellentesque</a>
								</p>
							</div>
							<h5>Description ::</h5>
							<p class="desc">Proin vestibulum scelerisque tempus.
								Phasellus at fermentum erat. Pellentesque mattis velit eget elit
								condimentum gravida. Donec vehicula mollis velit, a eleifend est
								hendrerit quis. Etiam pulvinar at ex eget cursus. Etiam luctus
								orci ut tortor rhoncus, sit amet faucibus lorem finibus. Nulla
								id ornare arcu. or lowest node and working upwards) are as
								follows:</p>
						</div>
						<div class="clearfix"></div>
					</div>
			...
			<div class="single-bottom2">
				...
				<div class="rltd-posts">
					<div class="col-md-3 pst1">
						...
						<h4>
							<a href="products.html">NEWLOOK</a>
						</h4>
